...
const slides: SlideData[] = [
    {
        id: 1,
        title: "How ResQsync Saves Lives",
    ...
    },
    {
        ...
        body: "Every day, India loses hundreds of people on the road — not because help doesn't exist, but because help doesn't arrive in time. Most accidents go unnoticed for minutes, sometimes even longer, and emergency vehicles get trapped in the same chaos they're racing to escape.\n\nResQsync was built to directly attack this life-and-death gap. It transforms the nation's existing traffic cameras into real-time responders that can detect an accident in under half a second and trigger immediate action. This is traffic infrastructure that doesn't just observe danger — it reacts to it.",
        icon: AlertTriangle,
    ...
    },
    {
        ...
        body: "With ResQsync, every intersection becomes a life-saving intelligence node. Our edge AI identifies collisions the moment they occur, flags stopped or damaged vehicles, recognizes blocked lanes, and understands critical incidents instantly — without depending on the cloud.\n\nThis drastic reduction in detection time means first responders can be alerted within seconds, turning minutes of delay into moments of action — and those moments can be the difference between survival and loss.",
        icon: Zap,
    ...
    },
    {
        ...
        body: "This isn't just smarter traffic — it's safer cities. With continuous accident analysis, real-time hazard discovery, predictive detection patterns, and intelligent ambulance routing, ResQsync becomes a silent guardian built into the streets.\n\nIt doesn't wait for reports. It doesn't wait for congestion to resolve itself. It acts instantly — preventing further injuries, accelerating emergency response, and ensuring that every second counts for the people whose lives depend on them.",
        icon: Activity,
