                    ...
                    {typeConfig.map((type) => (
                        <button
                            ...
                            className={`w-full flex items-center justify-between p-3 rounded-lg 
                                ...
                                ${filters.types[type.id] ? 'bg-slate-100/90 shadow-md text-slate-900 font-semibold' : 'bg-transparent text-slate-400'}
                            `}
                        >
                            ...
                            <div className={`w-12 h-6 rounded-full relative transition-colors ${filters.types[type.id] ? 'bg-indigo-600' : 'bg-slate-200'}`}>
                                <motion.div
